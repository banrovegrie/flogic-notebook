...
\section{Bit hacks}
	...
	\subsection{Bitset}
	\begin{itemize}
		\item \verb@bitset<100> b(5)@ or  \verb@bitset<100> b; b = 23;@.
		\item b.any(), b.all(), check if any or all bits set to true
		\item b[i], b.count(), \verb@for(int i=BS._Find_first();i< BS.size();i = BS._Find_next(i))@
	\end{itemize}
